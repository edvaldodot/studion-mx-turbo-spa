...
import DatatableEvaluations from '../components/DatatableEvaluations'
import ModalViewAllAttempts from '../components/ModalViewAllAttempts'
...
export default defineComponent({
  ...
  components: {
    ...
    FilterListOrder,
    FilterListTag,
    DatatableEvaluations,
    ModalViewAllAttempts,
    Pagination,
  },
  ...
  created() {
    ...
    this.pgtrInitializePagination('Management/evaluations/evaluationListResource')
  },
  ...
  <div :data-testid="$testId('tab-evaluation')">
    ...
    <div class="p-4">
      <DatatableEvaluations
        ...
        @redirect:correct="handleRedirectCorrect"
      ...
      <ModalViewAllAttempts ref="modalAttempts" />
    </div>
  </div>
</template>
