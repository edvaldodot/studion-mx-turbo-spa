...
export const defaultFilterTagOptions = () => [
  {
    ...
    items: [
      ...
      { text: i18n.t('community.sessions.filters:type.individual'), id: 'individual', property: 'type' }
    ]
  },
  {
  ...
  },
  {
    ...
    name: 'status',
    items: [
      { text: i18n.t('community.sessions.filters:status.in.progress'), id: 'in_progress', property: 'status' },
      { text: i18n.t('community.sessions.filters:status.ended'), id: 'ended', property: 'status' },
      { text: i18n.t('community.sessions.filters:status.not.started'), id: 'not_started', property: 'status' }
    ]
  },
  {
